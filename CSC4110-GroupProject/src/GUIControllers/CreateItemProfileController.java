...
public class CreateItemProfileController implements Initializable {
    ...
    String filePath = "ItemProfiles.ItemProfile.csv";
    ...
    private String[] Category = {"ItemProfiles.Vegetables", "ItemProfiles.Fruits", "ItemProfiles.Nuts", "ItemProfiles.Dairy",
            "ItemProfiles.Meat", "ItemProfiles.Snacks", "Profiles.Soda", "ItemProfiles.Juice", "Bakery"};
    @FXML
    ...
    public void switchToUserMenuScene(javafx.event.ActionEvent event) throws IOException {
        ...
        Root = FXMLLoader.load(getClass().getResource("GUIs/UserMenu.fxml"));
